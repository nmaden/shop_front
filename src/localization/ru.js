export default {
    ...
    welcome__description__one: '«eQonaq» - информационная система, предназначенная для осуществления в электронном виде сбора, учета и обработки данных принимающих лиц о пребывающих у них иммигрантах и внутренних мигрантах. Cистема повышает качество туристических услуг и привлекательность отечественного туризма, а также улучшает контроль за соблюдением миграционного законодательства Республики Казахстан.',
    welcome__description__two: 'Система создана в рамках реализации государственной программы развития туристической отрасли Министерством Культуры и Спорта при содействии Министерства Внутренних дел Республики Казахстан.',
