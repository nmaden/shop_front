export default {
    ...
    video__title: 'Небольшое видео о системе eQonaq',
    video__description: 'Небольшое видео о нашей системе, кто мы, как начать работу с eQonaq', 
    welcome__title: "Добро пожаловать в информационную cистему eQonaq",
    welcome__description__one: '«eQonaq» - государственная информационная система,  предназначенная для осуществления в электронном виде сбора, учета и обработки данных принимающих лиц о пребывающих у них иммигрантах и внутренних мигрантах, посредством автоматизации процессов их обязательной регистрации и  направления принимающими лицами уведомления в органы внутренних дел',
    welcome__description__two: 'Система создана в рамках реализации государственной программы развития туристической отрасли Министерством Культуры и Спорта при содействии Министерства Внутренних дел и Комитета Национальной безопасности Республики Казахстан.',
